...
export function isValidOrigin(location: string) {
  location = location.toLocaleLowerCase();

  return flights.some(
    (flight) => flight.originAirport.city.name.toLocaleLowerCase() === location
  );
}

export function isValidDestination(location: string) {
  location = location.toLocaleLowerCase();

  return flights.some(
    (flight) =>
      flight.destinationAirport.city.name.toLocaleLowerCase() === location
  );
}
